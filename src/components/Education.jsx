    ...
    return (
        <div className='mt-10 lg:px-6'>
            ...
            <div className="flex flex-col items-center lg:flex-row lg:items-start">
                ...
                />
                <Fade direction='left'>
                    <div className='w-11/12 text-center lg:text-left lg:px-4'>
                        ...
                        <p className='text-base mt-4 text-white text-justify'>
                            During my time at the University of Rajshahi, I developed a strong foundation in computer science and engineering principles. 
